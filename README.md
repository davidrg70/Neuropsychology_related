...
"dg_dprime_2afc.m" is intended to be used within a for loop. Given a <<cond_data>> table with a <<hit>> variable/column, it will count correct responses coded as 1s and incorrect responses or omissions coded as 0s to determine percent correct (PC) and D prime after a 2-alternative forced choice (2AFC) design. Every iteration of the for loop corresponds to a condition of the task.
